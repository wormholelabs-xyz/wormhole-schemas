...
{
  "$schema": "@wormhole-foundation/wormhole/vaa<@wormhole-foundation/token-bridge/transfer>",
...
Parse a payload, override fields, and rebuild — `parse` outputs JSON with a `$schema` field that `build` picks up automatically:

```
$ wsch parse 
{
  "$schema": "@wormhole-foundation/token-bridge/transfer",
  "amount": "100000000",
  "token-address": "000000000000000000000000dac17f958d2ee523a2206206994597c13d831ec7",
  "token-chain": "2",
  "to": "0000000000000000000000009876543210abcdef9876543210abcdef98765432",
...
$ wsch parse <hex> | wsch build amount=50000000 fee=1000

